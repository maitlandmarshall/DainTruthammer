...
- Dain Truthammer receives the `Ghostly Form Tattoo` as the harpy-fight reward; the Astral Elf did not receive the tattoo. [Party] [Character-only] [Confirmed] [Retcon] User correction recorded 2026-05-03.
...
- In the aftermath, Dain receives the `Ghostly Form Tattoo`; the reward belongs to Dain, not the Astral Elf. [Party] [Character-only] [Confirmed] [Retcon] User correction recorded 2026-05-03.
...
- Dain receives the `Ghostly Form Tattoo` as the reward after the harpy fight; it is not the Astral Elf's tattoo. [Party] [Character-only] [Confirmed] [Retcon] User correction recorded 2026-05-03.
...
- [Party] Dain Truthammer receives the `Ghostly Form Tattoo` reward with incorporeal movement properties; the Astral Elf does not receive or wear it. [Character-only] [Confirmed] [Retcon] User correction recorded 2026-05-03.
