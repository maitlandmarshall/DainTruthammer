...
- Active: investigate the [Coal Mine Puppet](../Codex/Items/Coal%20Mine%20Puppet.md): why the newcomers are glowing with magic, why `Identify` fails, why it bit Dain as he began praying to [Garl Glittergold](../Codex/Lore/Garl%20Glittergold.md), which coal mines the puppet means, and what the traders know about it.
