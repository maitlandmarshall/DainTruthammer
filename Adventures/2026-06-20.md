...
- Dain tries to embody "interesting, but essentially useless" by donating gold to local gnomes who worship [Garl Glittergold](../Codex/Lore/Garl%20Glittergold.md), receiving a half-pound sack in return, and planning to give that sack to the local church.
...
- **[Notebook page 1 transcription]**
  ...
  - Dain finds six gnomes in a building, gives each `1 gp`, says an unclear instruction, and receives a half-pound sack in return. [To verify contents and exact phrase]
...
- Dain receives a half-pound sack from local gnomes after donating gold. Contents and carrier are [To verify].
- Dain intends to give that half-pound sack to the local church. [To verify whether completed]
...
- Identify the half-pound sack's contents and whether Dain delivered it to the church.
