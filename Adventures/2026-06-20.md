...
- After the morning spell seed, the party travels about an hour east, reaches a stone bridge, and considers route options: a detour to [Truthhammer Mountain / the Truthhammer Mountains](../Codex/Places/Truthhammer%20Mountains.md) may add a day or two, while cutting through local tunnels may save time. Exact route, bridge crossing, and destination remain [To verify].
- Within about six hours, the party reaches a tunnel and a grand door; Norhan / [Hammerton Harry Drizddon](../Codex/Characters/Hammerton%20Harry%20Drizddon.md) pushes the door open on a natural `1`, revealing an entrance hearth. The moon elf lights the fire, but the expected mechanism or response does not occur. [To verify who "moon elf" refers to]
- The party finds a hidden passage and [Hammerton Harry Drizddon](../Codex/Characters/Hammerton%20Harry%20Drizddon.md) / "Dresden" breaks rubble with his hammer, which audibly protests. A spiral staircase descends into a passage unknown to the Truthhammers, and Dain says his father should be informed and the party should come back armed. [To verify exact names and whether Dain knows the stair is truly unknown to all Truthhammers]
- After another hour of travel, the floor collapses beneath the party; below is the Underdark, there may be a roper, and Dain begins stepping back after sensing danger.

## Links
- Previous session: [Session 2026-05-30](./2026-05-30.md)
- Next session: [Session 2026-07-11](./2026-07-11.md)
...
![Notebook page 9](./2026-06-20/2026-06-20_notes-page-09.jpg)

![Notebook page 10](./2026-06-20/2026-06-20_notes-page-10.jpg)

![Notebook page 11](./2026-06-20/2026-06-20_notes-page-11.jpg)
...
- **[Notebook page 5 transcription]**
  ...
  - Harry / [Hammerton Harry Drizddon](../Codex/Characters/Hammerton%20Harry%20Drizddon.md) asks Dain for [his seal](../Codex/Items/Dains%20Seal.md); Dain provides it in exchange for `100 gp` worth of silver. [To verify exact object, whether this is Dain's personal seal/signet/stamp, and whether it is lent, pawned, or permanently transferred]
...
- **[Notebook page 9 transcription]**

  ```text
  - begins writing in his wizard
    book the beginning of his new
    spell

  - [crossed-out line unclear]

  - We travel about an hour to the east
  - We come across a stone bridge
    that crosses [unclear]

  - note that a detour to truthammer
    mountain will add a day or two
    of travel, cutting through local
    tunnels could cut some time off

  - We arrive at the tunnel within 6
    hours, and arrive at at a grand
    door.
  ```

  - The earlier spell-writing beat continues at the top of this page.
  - The party travels about an hour east.
  - The party comes across a stone bridge that crosses an unclear feature. [To verify what it crosses]
  - Dain notes that detouring to Truthhammer Mountain / the [Truthhammer Mountains](../Codex/Places/Truthhammer%20Mountains.md) would add a day or two of travel.
  - Dain notes that cutting through local tunnels could save time. [To verify whether this is Dain's knowledge, party knowledge, or table route planning]
  - Within about six hours, the party arrives at a tunnel and a grand door.

- **[Notebook page 10 transcription]**

  ```text
  - Norhan pushes open the door
    with a natural 1.
  - Finds a hearth at the entrance
  - The moon elf lights the fire
  - [crossed-out line unclear]

  - The party finds a hidden passage
    and Dresden busts down the rubble
    with their hammer, the hammer
    audibly protests.
    - a spiral staircase goes
      straight down, unknown to
      the Truthhammers

  - Dain was expecting lighting the fire
    to do something, but nothing occurs

  - Dain mentions we should inform his
    father of this passage and come
    back armed.

  - As travelling through the mountains,
    Dain tells stories his father told
    him of fire spirits that have spirits
    haunting the mountain.
  ```

  - Norhan / [Hammerton Harry Drizddon](../Codex/Characters/Hammerton%20Harry%20Drizddon.md) pushes open the grand door on a natural `1`. [To verify whether this is Hammerton acting through Norhan]
  - The party finds a hearth at the entrance.
  - The moon elf lights the fire. [To verify whether this is [Kagrenac](../Codex/Characters/The%20Astral%20Elf.md), another party member, or a note shorthand]
  - Dain expected lighting the fire to do something, but nothing happens.
  - The party finds a hidden passage.
  - "Dresden" / [Hammerton Harry Drizddon](../Codex/Characters/Hammerton%20Harry%20Drizddon.md) busts down rubble with his hammer, and the hammer audibly protests. [To verify exact name and hammer identity]
  - A spiral staircase descends straight down, apparently unknown to the Truthhammers. [To verify whether this means unknown to Dain, his father, or the clan]
  - Dain says the party should inform his father of this passage and come back armed.
  - While traveling through the mountains, Dain tells stories his father told him of fire spirits and spirits haunting the mountain. [To verify exact folklore wording]

- **[Notebook page 11 transcription]**

  ```text
  - After travelling an hour the floor
    collapses beneath us.

  - Below is the underdark.
  - Potentially a roper.

  - Truthammer, sensing danger begins
    to step back
  ```

  - After another hour of travel, the floor collapses beneath the party.
  - Below the collapse is the Underdark.
  - A roper may be present, but this is not confirmed.
  - Dain / Truthammer senses danger and begins to step back.

## Character State Changes
- Dain's exact current HP remains [To verify].
- Dain's exact current coin balance is now [To verify]; the notebook records at least `6 gp` donated to gnomes, an intended attempt to donate to 10 gnomes, tavern drinks, dice wagers/winnings, a `1 gp` transfer to Ollyander, `100 gp` worth of silver received for [Dain's Seal](../Codex/Items/Dains%20Seal.md) and then bet, a [human/townsperson](../Codex/Characters/Rat-House%20Human%20-%202026-06-20.md) trade involving `60 gp` worth of silver, and Dain later giving his last `5 gp` to that person. His gold-piece balance is therefore likely `0`, while silver and other coin holdings remain [To verify].
...
- Dain provides [Dain's Seal](../Codex/Items/Dains%20Seal.md) to Harry / Hammerton Harry Drizddon in exchange for `100 gp` worth of silver. Exact object, ownership status, and whether Dain can reclaim it are [To verify].
...
- Current live location/status has moved from the unnamed town to a [hidden tunnel near Truthhammer Mountain](../Codex/Places/Hidden%20Tunnel%20Near%20Truthammer%20Mountain.md), where the floor has collapsed over the Underdark and a possible roper may be below. Exact marching order, fall results, initiative, and creature identity are [To verify].
- Dain has identified the hidden passage as important enough to inform his father and return armed. Whether this is a personal family warning, a clan-security concern, or both is [To verify].
...
- A route through or near [Truthhammer Mountain / the Truthhammer Mountains](../Codex/Places/Truthhammer%20Mountains.md) is now in play: a detour may add a day or two, while local tunnels may save time. [To verify exact geography and whether this affects [Agland's Sealed Letter](../Codex/Items/Aglands%20Sealed%20Letter.md)]
- The party reaches a tunnel with a grand door, an entrance hearth, a hidden passage, rubble, and a spiral staircase that descends into unknown depths.
- A hidden passage near the Truthhammer route may be unknown to the Truthhammers, and Dain wants his father informed before the party returns armed. [To verify scope of "unknown"]
- Dain carries or repeats father-taught stories about fire spirits / spirits haunting the mountain. Exact folklore, truth, and campaign cosmology are [To verify].
- The floor collapses after roughly another hour of travel; below is the Underdark, and a roper may be present. [To verify]
...
- Confirm the dice-game aftermath: final pot, exact silver flow, whether Taleesh objectively cheated, what Taleesh does after failing the `Suggestion` save, whether [Dain's Seal](../Codex/Items/Dains%20Seal.md) can be reclaimed, and whether this creates lasting party tension.
...
- Survive the hidden tunnel collapse, confirm whether anyone fell, identify the possible roper, and determine whether to fight, retreat, or secure the area.
- Decide whether to continue through the local tunnels, retreat to the grand door, or mark the hidden passage and return after warning Dain's father / the Truthhammers.
- Confirm what Dain knows from family stories about fire spirits, spirits haunting the mountain, hidden passages, and any Underdark connection beneath the Truthhammer route.
...
![Hidden tunnel grand door and hearth](./2026-06-20/2026-06-20_hidden-tunnel-grand-door.png)

- Canon beat image: the party at the grand tunnel door, with the entrance hearth lit and the hidden passage starting to reveal itself. The exact moon elf identity and hammer details are [To verify].

![Floor collapse above the Underdark](./2026-06-20/2026-06-20_floor-collapse-underdark-roper.png)

- Canon beat image: the floor collapse over the Underdark and the possible roper threat below. The roper is still only `potentially` present until confirmed at the table.
