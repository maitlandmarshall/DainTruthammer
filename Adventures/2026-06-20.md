...
- Harry / [Hammerton Harry Drizddon](../Codex/Characters/Hammerton%20Harry%20Drizddon.md) asks for Dain's seal, Dain provides it in exchange for `100 gp` worth of silver, then bets that silver; Dain loses the betting round, [Ollyander](../Codex/Characters/Ollyander.md) wins, and a human/townsperson silver exchange creates a new rat-and-poverty action thread. [To verify exact seal, silver ownership, and human identity]
- Dain gives his last `5 gp` to the human/townsperson tied to the rat problem, leaving his gold-piece balance likely at `0`; exact silver and other coin holdings remain [To verify].
...
- **[Notebook page 5 transcription]**
  ...
  - A human runs away after seeing the amount of money. [To verify whether this is the same human from the tavern drink or another townsperson]
  - Dain notes that the town has issues with rats and poverty.
  - Action item: fix the rat problem, find the human, and give silver.
...
- **[Notebook page 6 transcription]**
  ...
  - A townsperson from before, apparently the human, is involved in a trade with Ollyander worth `60 gp` in silver. [To verify direction of trade, whether the value is `60 gp`, and whether this is the same human who ran away]
  - Dain tells the human he has an ambition to rid that house of rats: "Gather the rats while I'm gone." [To verify the house, whether the human accepts, and whether the rats are ordinary, magical, diseased, or connected to the earlier `3 rats` note]
...
- **[Notebook page 7 transcription]**
  ...
  - This page reinforces the same rat-house thread: Dain tells the human/townsperson, "Gather the rats while I'm gone." [To verify exact human, house, and rat situation]
  - Dain gives his last `5 gp` to the human/townsperson. This likely leaves Dain with `0 gp`, while silver and other coin holdings remain [To verify] because of the unresolved seal-for-silver and betting flow.
...
- Dain's exact current coin balance is now [To verify]; the notebook records at least `6 gp` donated to gnomes, an intended attempt to donate to 10 gnomes, tavern drinks, dice wagers/winnings, a `1 gp` transfer to Ollyander, `100 gp` worth of silver received for Dain's seal and then bet, a human/townsperson trade involving `60 gp` worth of silver, and Dain later giving his last `5 gp` to the human/townsperson. His gold-piece balance is therefore likely `0`, while silver and other coin holdings remain [To verify].
...
- Dain opens a new town action item: address rats and poverty by finding the human/townsperson and giving silver. [Character-only] [To verify exact person and silver amount]
...
- The town has visible issues with rats and poverty, and at least one human/townsperson is central enough that Dain records an action item to find them and give silver. [To verify identity, house, and social context]
- Dain gives his last `5 gp` to the human/townsperson tied to the rat-house thread. [To verify exact person and whether any silver is also given later]
...
- Follow up on the town rat-and-poverty action item: identify the human/townsperson, locate the house, gather or inspect the rats, and decide how much silver Dain can safely give.
