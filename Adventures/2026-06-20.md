...
- Dain's exact current coin balance is now [To verify]; the notebook records at least `6 gp` donated to gnomes, an intended attempt to donate to 10 gnomes, tavern drinks, dice wagers/winnings, a `1 gp` transfer to Ollyander, `100 gp` worth of silver received for Dain's seal and then bet, and a human/townsperson trade involving `60 gp` worth of silver.
