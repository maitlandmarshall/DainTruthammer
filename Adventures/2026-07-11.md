...
- Dain finishes the [Sauna Pelt](../Codex/Items/Sauna%20Pelt.md). Its confirmed final traits are constant warmth in cold environments and wetness that smells like wolf piss; whether the earlier lethal-steam risk remains is [To verify].
...
- [Character-only] Confirmed finished traits: the pelt is always warm in any cold environment, and its wetness always smells like wolf piss. [To verify exact mechanical wording, carrier, attunement, and whether the earlier steam/scalding risk remains]
...
- [Character-only] The completed Sauna Pelt is always warm in cold environments, and its wetness smells like wolf piss.

## Open Threads
- Immediate: answer Kagrenac's murder accusation and establish the dead dwarf's identity, cause of death, and connection to Dain's century-old escape.
- Identify Dain's sacrificed friend and the troopers who pursued them through the tunnels one hundred years ago.
- Clarify the illegible notebook line naming the dead dwarf and mentioning studded cold leather.
...
- Confirm the completed Sauna Pelt's carrier, exact mechanics, and whether its earlier lethal-steam risk remains.
