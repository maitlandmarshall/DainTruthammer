...
- [Party] Two creatures called `crymeria` attack the skyship shortly after takeoff. Whether these are standard chimeras or a distinct creature is [To verify].
...
- Encounter state: two airborne creatures called `crymeria` are attacking the skyship. Initiative, exact creature identity, ship damage, passenger injuries and actions taken are [To verify].
...
- Southbound skyship attack: identify the two `crymeria`, establish initiative and range, protect the balloon and lift system, learn whether the cannon can bear on them, and track damage, resources, injuries and each creature's fate.
