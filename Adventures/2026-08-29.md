...
- [Resolved] The party chose and boarded the [balloon-like skyship](../Codex/Places/Party%20Skyship%20-%202026-08-29.md); it is now airborne and travelling south.
...
## Summary
- [Party] The party departs Ola Dung Lot aboard its balloon-like skyship, heading south on the captive-recovery and southwestern-warning mission.
- [Party] Two creatures called `crymeria` attack shortly after takeoff. Taleesh rapidly descends to the ground using rope from the balloon's chest and drives downward toward a chimera; the party destroys both attackers. Whether `crymeria` means standard chimeras remains [To verify].
- [Character-only] Dain acquires a [Flying Broom](../Codex/Items/Flying%20Broom.md). Its source and exact mechanics remain [To verify].
...
- **[Prompt]**
  ...
  ```text
  Taleesh gains Taleesh rolls and 18 for respect for succeeding the ritual without showing pain and just his outlook on it
  ```

- [Party] [Confirmed] Taleesh succeeds at Moradin's forge ritual without showing pain. His success and his outlook—wanting the experience for its own sake—produce a confirmed respect result of `18`. [To verify] Whether `18` is respect gained, a respect roll, or the resulting respect total; whether Taleesh felt concealed pain; what he offered and retrieved; and whether he sustained any unseen injury.
- **[Prompt]**

  ```text
  for a brief moment you see an azer in the forge before they disappear again into the fire
  ```

- [Party] [Confirmed] For a brief moment, an unidentified [azer](../Codex/Characters/Azer%20in%20Moradins%20Forge.md) appears within Moradin's symbolic forge before disappearing back into the fire. Its identity, intent, physical reality, awareness of the party, and connection—if any—to Taleesh's ritual, Dain's half-Azer heritage or the Truthhammer forges are [To verify].
- **[Prompt]**

  ```text
  I perform the ritual inspired by the vision and by Taleesh, as I’m grabbing the rod it goes colder and I grow hotter. My skin seems to have a bronze sheen to it. When I put the rod down, I feel a sense of guilt for not tending the Truthammer forge, like a catholic guilt.
  ```

- [Character-only] [Confirmed] Inspired by the azer vision and Taleesh, Dain performs the forge ritual. As he grasps [the rod](../Codex/Items/Moradins%20Forge%20Ritual%20Rod.md), it grows colder while Dain grows hotter, and his skin takes on a bronze sheen. When he sets the rod down, Dain feels intense religious guilt for failing to tend the Truthammer forge. `Catholic guilt` is preserved as the table-side comparison; in-world, the feeling concerns Dain's perceived neglected duty to his ancestral forge. The source, duration and mechanics of the temperature exchange, bronze sheen and guilt are [To verify].
- **[Prompt]**

  ```text
  As the moon hits the eye, I’d like to go be a pizza pie. Taleesh says this to Truthammer before he leaves in a bit of surprise.
  ```

- [Party] [Confirmed] In a surprised tone before leaving the immediate scene, Taleesh tells Dain, “As the moon hits the eye, I’d like to go be a pizza pie.” The line is preserved exactly rather than normalized to the familiar song lyric. Taleesh's destination, reason for leaving, meaning and cause of surprise are [To verify].
- **[Out-of-character DM lore supplied by user]**

  ```text
  If you want to do the azer thing, It would be something along the lines of you recieved a bit of magic from the elemental plane of fire.
  The forge under truthammer has an open portal to the elemental plane of fire that appeared when you had the incident

  How Creation WorksThe Shell: An azer carefully crafts a dwarf-shaped outer shell made of bronze.The Spark: The creator transfers a part of its inner elemental flame and life force into the bronze body.The Result:
  ```

- [DM-private] [Superseded conditional framing] This exact DM wording is new to the archive. It proposes that Dain received fire-plane magic, the Truthammer forge incident opened a portal to the Elemental Plane of Fire, and azer creation begins with a crafted bronze dwarf-shaped shell receiving part of its creator's elemental flame and life force. Because the wording begins `If you want to do the azer thing`, it remains [idea-stage](../Codex/Brainstorm/Lore/Azer%20Spark%20and%20Truthammer%20Fire%20Portal.md), not settled canon. The source ends at `The Result:`, so the outcome is [Incomplete] and must not be invented.

- **[Prompt]**

  ```text
  No the ritual before was me accepting the azer connection
  ```

- [Character-only] [Confirmed correction] Dain's ritual in Moradin's chamber was his conscious acceptance of the [azer connection](../Codex/Lore/Azer%20Spark%20and%20Truthhammer%20Fire%20Portal.md). This promotes the DM's fire-plane magic and Truthammer portal account from the immediately preceding conditional proposal into canon. The heat, bronze sheen and forge-guilt are manifestations or consequences of that acceptance. The exact nature of Dain's connection and the incomplete `The Result:` remain [To verify].

- **[Prompt]**

  ```text
  We take off towards the south and two crymeria attack us
  ```

- [Party] [Confirmed] The party takes off from [Ola Dung Lot](../Codex/Places/Ola%20Dung%20Lot.md) aboard its [balloon-like skyship](../Codex/Places/Party%20Skyship%20-%202026-08-29.md) and travels south. Two airborne creatures identified table-side as `crymeria` attack the ship. They are linked as the [Crymeria Attackers](../Codex/Characters/Crymeria%20Attackers%20-%202026-08-29.md); whether the intended creature name is `chimera`, whether both are standard chimeras, their approach, initiative, attacks, targets, damage and current positions are [To verify].

- **[Prompt]**

  ```text
  Taleesh rapidly descends to the ground using rope from the hot air balloons chest, and missiles down towards the Chimera.
  We destroy them.
  Truthammer gets a flying broom.
  ```

- [Party] [Confirmed] [Brother Taleesh](../Codex/Characters/Brother%20Taleesh.md) rapidly descends to the ground using rope taken from the hot-air balloon's `chest`, then `missiles down` toward one of the chimera-like attackers. The quoted words preserve the user's description: whether `chest` means a storage chest aboard the skyship and whether `missiles down` describes movement, a monk feature, an attack or another mechanic are [To verify].
- [Party] [Confirmed] The party destroys both [crymeria attackers](../Codex/Characters/Crymeria%20Attackers%20-%202026-08-29.md). Final attacks, damage, bodies, salvage and any damage or casualties aboard the skyship remain [To verify].
- [Character-only] [Confirmed] Dain Truthammer receives a [Flying Broom](../Codex/Items/Flying%20Broom.md). Its source, whether it is the standard magic item `Broom of Flying`, command word, flight speed, carrying capacity, attunement, current stowage and whether Dain immediately mounts it are [To verify].

## Character State Changes
- Canon clarification: Dain's forge ritual was his acceptance of the azer connection. He now carries a measure of magic from the Elemental Plane of Fire; the Truthammer forge's open portal is established history.
...
- Location/transport update: the party has boarded its skyship, taken off from Ola Dung Lot and begun travelling south.
- Encounter resolution: Taleesh rapidly descends to the ground on rope from the balloon's `chest` and drives downward toward one attacker; the party destroys both `crymeria`. Exact mechanics, final blows, ship damage, passenger injuries, resources spent and Taleesh's return aboard are [To verify].
- New item: Dain acquires a flying broom. Exact item identity, source, mechanics, attunement and current stowage are [To verify].
...
- Relationship change: Taleesh succeeds at the ritual without showing pain, and his success plus experience-seeking outlook produces a respect result of `18`. [To verify whether this is gained respect, a roll or a final total]
- Supernatural sighting: an azer briefly appears within the forge and vanishes back into the fire.
- Personal transformation: Dain performs the ritual; the rod cools, Dain heats, his skin gains a bronze sheen, and he experiences intense guilt over neglecting the Truthammer forge after putting the rod down.
- Party-position change: Taleesh gives Dain a surprised, surreal farewell and leaves the immediate chamber scene. His destination is [To verify].

## New Canon / Important Discoveries
- [Character-only] [Confirmed] Dain accepts the azer connection through Moradin's forge ritual. The accepted DM account establishes fire-plane magic in Dain and an open Elemental Plane of Fire portal beneath Truthammer that appeared during his earlier incident.
...
- [Character-only] [Confirmed] Dain respects Taleesh more after Taleesh succeeds at the ritual without showing pain and demonstrates that the experience itself was worth the risk. The recorded respect result is `18`; its exact tracker meaning is [To verify].
- [Party] [Confirmed] An azer can briefly be seen within Moradin's forge before disappearing into the flames.
- [Character-only] [Confirmed] Dain's ritual produces an inverse heat response between himself and the rod, a bronze sheen on his skin, and a powerful sense of neglected religious or ancestral duty toward the Truthammer forge.
- [Party] [Confirmed] Taleesh's final line before leaving is, “As the moon hits the eye, I’d like to go be a pizza pie.”
- [Party] [Confirmed] The skyship departs Ola Dung Lot southbound and is attacked by two airborne `crymeria`. The name and standard-creature equivalence remain [To verify].
- [Party] [Confirmed] Taleesh makes a rapid rope descent from the skyship toward one attacker, and the party destroys both creatures.
- [Character-only] [Confirmed] Dain acquires a flying broom; no exact rules have yet been established.

## Open Threads
- Azer connection: determine the exact magic Dain received, how the accepted connection works mechanically, the portal's current state, whether Dain was born/crafted/transformed/empowered, and the missing continuation after `The Result:`.
...
- Taleesh's successful ritual: determine what metal he offered, what he retrieved, whether Moradin protected him, whether he concealed pain or suffered unseen injury, and whether the respect result `18` is gained respect, a roll or the final total.
- Azer in the forge: identify the figure, determine whether it was physically present or a vision, learn whether it caused or observed the ritual, and investigate any connection to Moradin, the adjacent temple, Dain's half-Azer heritage or the Truthhammer forge tradition.
- Dain's ritual transformation: determine how long the heat and bronze sheen last, whether there are mechanical effects, whether the guilt is magical or personal, what tending the Truthammer forge would require, and whether Dain now feels compelled to return home.
- Taleesh's departure: establish where he goes, whether he remains nearby or with the party, what surprised him, and what he meant by wanting to “go be a pizza pie.”
- Resolved — Southbound skyship attack: both `crymeria` were destroyed. Preserve as follow-up questions their exact identity, Taleesh's descent mechanics, final blows, bodies or salvage, ship damage, resources and passenger injuries.
- Flying broom: identify its source and exact item rules, establish its command word and ownership details, determine whether it requires attunement, and record when Dain first flies it.
...
- Current scene:
  ...
  ![Taleesh gives Dain a surprised farewell before leaving Moradin's chamber](./2026-08-29/2026-08-29_taleesh-pizza-pie-farewell.png)

  ![Two crymeria attack the party's southbound balloon skyship](./2026-08-29/2026-08-29_southbound-skyship-crymeria-attack.png)

  ![Taleesh rapidly descends by rope toward a crymeria](./2026-08-29/2026-08-29_taleesh-rope-descent-crymeria.png)

- New item reference:

  ![Dain's newly acquired flying broom](../Codex/Items/Flying_Broom_ref.png)
