...
- Species: Dwarf
- Class/Subclass: Wizard 3 / School of Conjuration
- Background: Sage
- Age: 107
- Gender: Male
- Size: Medium
...
## Skills And Saves
- Saving Throws: Strength +2, Dexterity +0, Constitution +1, Intelligence +7, Wisdom +3, Charisma +2
...
## Resources
- Spell Slots: 1st level 4/4, 2nd level 1/2 [`Suggestion` cast on the goblin leader during the goblin toll encounter on 2026-05-03]
...
- Current location: Exiting the goblin camp on the cold mountain route after the forest long rest. Earlier this same morning, [Southern Human Traders](../Codex/Factions/Southern%20Human%20Traders.md) approached asking for the way to [Olar Dunglor](../Codex/Places/Olar%20Dunglor.md); Dain persuaded them with a natural `20` to trust the party, accepted half-now/half-later payment into [Party Loot](./Party%20Loot.md), and added five truthful answers owed upon delivery after the [Coal Mine Puppet](../Codex/Items/Coal%20Mine%20Puppet.md) reveal. Kagrenac has privately warned Dain in Draconic that the newcomers are glowing in magic, Dain's attempted `Identify` on the puppet has failed or been prevented, the puppet has bitten Dain as he began praying to [Garl Glittergold](../Codex/Lore/Garl%20Glittergold.md), and Dain now realizes it is a cobalt puppet that says "[Kurtlemack](../Codex/Lore/Kurtlemack.md) hates you." [Brother Taleesh](../Codex/Characters/Brother%20Taleesh.md) / Jackson opened the goblin encounter by calling, "Brothers, allow us to join your camp?" and offering medicine to trade with their boss in a friendly, family-like tone. Dain cast `Minor Illusion` 30 feet ahead as a complete copy of himself to distract and shield line of sight toward the goblins. The goblins demanded a toll to pass, and Dain challenged the demand by asking what the toll was and saying the roads had been free since he was a wee lad. Taleesh met a goblin on neutral ground and covertly passed one [goji leaf](../Codex/Items/Taleeshs%20Herbal%20Stash.md) with one gold piece through a firm, angled handshake. When the goblin demanded more gold, Taleesh drew his scimitar and held it at the goblin's neck. Dain offered the [Hedgehog Mushroom Lantern](../Codex/Items/Hedgehog%20Mushroom%20Lantern.md) to the goblin leader as food and cast `Suggestion`: "Allow us safe passage, a meal, and a way through." The goblin leader took `4` fire damage while eating the lantern, but `Suggestion` remained active because Dain did not directly cause the damage. The other goblins behind the leader began reacting as though things were going down after seeing their leader's head light on fire. Taleesh punched at the goblin to assert dominance, but the attack roll failed and dealt no damage; the goblin did not snap out of confusion and instead laughed at Taleesh. The human traders who initially refused to enter the goblin camp and break bread are convinced to enter with the party and goblins; everyone gathers around the fire and begins cooking breakfast together. [Hammerton Harry Drizddon](../Codex/Characters/Hammerton%20Harry%20Drizddon.md) / Norhan goes around the outside of the tent and persuades goblins one by one to join the meal. Dain tells [The Toll That Paid Itself](../Codex/Lore/Truthammer%20Tales/The%20Toll%20That%20Paid%20Itself.md) around the goblin campfire, then puts his arm around the hobgoblin leader and shares stories of his mother, apprenticeship, and early training. [Kagrenac](../Codex/Characters/The%20Astral%20Elf.md) / Matt poisons the shared food with [Sytxweed Plant](../Codex/Items/Sytxweed%20Plant.md); the goblins eat it and forget about the party, while the leader remains charmed and happy the party is there for now. As the party walks out, the moon elf and fighter dwarf steal a [Goblin Camp Chest](../Codex/Items/Goblin%20Camp%20Chest.md) while the goblins remain under the influence of the styx / sytxweed potion. The moon elf and Norhan open the chest and find `500 gp` plus a [Mask of Changed Appearance](../Codex/Items/Mask%20of%20Changed%20Appearance.md). [Party] [Character-only] [Confirmed on 2026-05-03] [To verify whether Dain notices the hidden handoff, later payment, Identify resource cost, bite damage, bite trigger, Kurtlemack context, truthful-answer trigger, exact medicine, toll amount, goblin authority, illusion effectiveness, rear goblin actions, human-goblin trust after breakfast, goblin reaction to Dain's tale, how many goblins join the meal, whether the leader is a hobgoblin, reaction to Dain's personal stories, exact sytxweed/styx spelling/mechanics/duration, whether non-goblins ate the poisoned food, gold split, mask carrier/mechanics, and final lantern state]
