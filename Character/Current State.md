...
## Resources
- Spell Slots: 1st level 3/4 [`Chromatic Orb` cast at the werebear on 2026-05-03, presumed slot use unless table confirms another resource], 2nd level 1/2 [`Suggestion` cast on the goblin leader during the goblin toll encounter on 2026-05-03]; if Dain's failed blinding attempt against the werebear was `Blindness/Deafness` or another slot-consuming spell, 2nd-level slots may now be `0/2`. [To verify exact blinding spell/effect and resource cost]
