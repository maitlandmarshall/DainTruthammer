...
- Current location: In the forest roughly 30 minutes beyond the goblin camp, around midday, near the newly spotted [Smoky Scratch-Marked Cave](../Codex/Places/Smoky%20Scratch-Marked%20Cave.md). Earlier this same morning, [Southern Human Traders](../Codex/Factions/Southern%20Human%20Traders.md) approached asking for the way to [Olar Dunglor](../Codex/Places/Olar%20Dunglor.md); Dain persuaded them with a natural `20` to trust the party, accepted half-now/half-later payment into [Party Loot](./Party%20Loot.md), and added five truthful answers owed upon delivery after the [Coal Mine Puppet](../Codex/Items/Coal%20Mine%20Puppet.md) reveal. The party then negotiated through a goblin camp, drugged the shared food with [Sytxweed Plant](../Codex/Items/Sytxweed%20Plant.md) / styx potion, left the goblins behind memory-impaired, and took the contents of the [Goblin Camp Chest](../Codex/Items/Goblin%20Camp%20Chest.md): `500 gp` and a [Mask of Changed Appearance](../Codex/Items/Mask%20of%20Changed%20Appearance.md). The party now smells potently of goblin pus. [Kagrenac](../Codex/Characters/The%20Astral%20Elf.md)'s owl has spotted a cave/nest with four very large scratch marks on nearby trees, fur on the rocks, and smoke coming from the cave. [Party] [Character-only] [Confirmed on 2026-05-03] [To verify later payment, Identify resource cost, bite damage, bite trigger, Kurtlemack context, truthful-answer trigger, exact sytxweed/styx spelling/mechanics/duration, whether non-goblins ate the poisoned food, gold split, mask carrier/recharge/duration/attunement, whether the goblin-pus smell has consequences, and what occupies the cave]
