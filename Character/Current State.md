...
- Current location: At the [Smoky Scratch-Marked Cave](../Codex/Places/Smoky%20Scratch-Marked%20Cave.md) in the forest roughly 30 minutes beyond the goblin camp, around midday. Earlier this same morning, [Southern Human Traders](../Codex/Factions/Southern%20Human%20Traders.md) approached asking for the way to [Olar Dunglor](../Codex/Places/Olar%20Dunglor.md); Dain persuaded them with a natural `20` to trust the party, accepted half-now/half-later payment into [Party Loot](./Party%20Loot.md), and added five truthful answers owed upon delivery after the [Coal Mine Puppet](../Codex/Items/Coal%20Mine%20Puppet.md) reveal. The party then negotiated through a goblin camp, drugged the shared food with [Sytxweed Plant](../Codex/Items/Sytxweed%20Plant.md) / styx potion, left the goblins behind memory-impaired, and took the contents of the [Goblin Camp Chest](../Codex/Items/Goblin%20Camp%20Chest.md): `500 gp` and a [Mask of Changed Appearance](../Codex/Items/Mask%20of%20Changed%20Appearance.md). The party now smells potently of goblin pus. [Kagrenac](../Codex/Characters/The%20Astral%20Elf.md)'s owl spotted the cave/nest with four very large scratch marks on nearby trees, fur on the rocks, and smoke coming from the cave. As the party approaches, they hear grunting and growling; a voice from the cave yells, "you should leave." Dain yells back, "we're coming," and a [Werebear at Smoky Cave](../Codex/Characters/Werebear%20at%20Smoky%20Cave.md) reveals itself. Combat begins or escalates when [Brother Taleesh](../Codex/Characters/Brother%20Taleesh.md) bites and strikes the werebear, saying "ouch," while [Hammerton Harry Drizddon](../Codex/Characters/Hammerton%20Harry%20Drizddon.md) attacks with a hammer, missing once and hitting once. Dain attempts to blind the werebear, but it succeeds on its Constitution save and is not blinded. The moon elf summons a weasel from a [Bag of Tricks](../Codex/Items/Bag%20of%20Tricks.md), and the werebear tries to hit and swing at it but completely misses. Dain then casts `Chromatic Orb` at the werebear, choosing acid and dealing `11` acid damage. The werebear rolls a natural `1` swinging its greataxe at [Brother Taleesh](../Codex/Characters/Brother%20Taleesh.md) / Jackson, loses the weapon, and sends it flying onto the cave roof out of reach. [Party] [Character-only] [Confirmed on 2026-05-03] [To verify later payment, Identify resource cost, bite damage, bite trigger, Kurtlemack context, truthful-answer trigger, exact sytxweed/styx spelling/mechanics/duration, whether non-goblins ate the poisoned food, gold split, mask carrier/recharge/duration/attunement, whether the goblin-pus smell has consequences, the werebear's motive, initiative, werebear reaction, total damage dealt, blinding spell/resource cost, Chromatic Orb resource source, Bag of Tricks owner/type, weasel duration/stats, and greataxe retrieval options]
