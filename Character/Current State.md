...
- [Character-only] Watch the goblin camp carefully while [Brother Taleesh](../Codex/Characters/Brother%20Taleesh.md) attempts a kinship-first approach, Dain's `Minor Illusion` copy shields line of sight, the goblins press their toll demand, and Taleesh attempts a hidden goji-leaf handoff.
