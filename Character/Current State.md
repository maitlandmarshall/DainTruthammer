...
- Current location: Forested mountain camp roughly 20 minutes beyond the defeated harpy nest, at the start of a new day after the completed long rest. Cold winds are blowing, [Kagrenac](../Codex/Characters/The%20Astral%20Elf.md) warns they will worsen today, and [Southern Human Traders](../Codex/Factions/Southern%20Human%20Traders.md) have approached asking for the way to [Olar Dunglor](../Codex/Places/Olar%20Dunglor.md). Dain has persuaded them with a natural `20` to trust the party and come with them, then delegated price-setting to [Hammerton Harry Drizddon](../Codex/Characters/Hammerton%20Harry%20Drizddon.md). The arrangement is half now, half later; the upfront half is [Burdock](../Codex/Items/Burdock.md) x10 oz and [Ginseng](../Codex/Items/Ginseng.md) x2 oz in [Party Loot](./Party%20Loot.md), with the later half still owed. Kagrenac has privately warned Dain in Draconic that the newcomers are glowing in magic, Dain's attempted `Identify` on the [Coal Mine Puppet](../Codex/Items/Coal%20Mine%20Puppet.md) has failed or been prevented, and the puppet has bitten Dain as he began praying to [Garl Glittergold](../Codex/Lore/Garl%20Glittergold.md). [Party] [Character-only] [Confirmed on 2026-05-03] [To verify later payment, Identify resource cost, bite damage, and bite trigger]
...
- [Character-only] Investigate why the newcomers glow with magic, why the [Coal Mine Puppet](../Codex/Items/Coal%20Mine%20Puppet.md) can apparently block or resist `Identify`, and why it bit Dain when he began praying to [Garl Glittergold](../Codex/Lore/Garl%20Glittergold.md).
