...
- Location/status: Airborne aboard the party's [balloon-like skyship](../Codex/Places/Party%20Skyship%20-%202026-08-29.md), travelling south from [Ola Dung Lot](../Codex/Places/Ola%20Dung%20Lot.md) on the captive-recovery and southwestern-warning mission. Two [crymeria](../Codex/Characters/Crymeria%20Attackers%20-%202026-08-29.md) are attacking the ship. Whether the intended creature name is `chimera` remains [To verify].
- Immediate scene: Active aerial attack by two airborne `crymeria`; initiative, ranges, creature traits, ship damage, passenger injuries and Dain's next action are [To verify].
...
- Immediate unresolved state: survive the two-crymeria attack and protect the skyship's balloon, crew and cannon; confirm initiative, ranges, damage and resources; then continue south, obtain an introduction letter if still outstanding, identify the raided settlements, captives, cult, Yuan-ti role and southwestern contacts; learn what Harry extracted from the puppet; determine why holy fire killed the traders; establish Bag of Holding ownership; confirm and potentially equip the newly acquired [Dwarven Half Plate](../Codex/Items/Dwarven%20Half%20Plate.md); and reconcile Dain's HP, spell slots, coin, smoke powder, Breastplate charges, seal and other resources.
