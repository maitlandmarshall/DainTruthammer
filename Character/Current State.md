...
## Resources
- Spell Slots: 1st level 4/4, 2nd level 1/2 [`Suggestion` cast on the goblin leader during the goblin toll encounter on 2026-05-03]; if Dain's failed blinding attempt against the werebear was `Blindness/Deafness` or another slot-consuming spell, 2nd-level slots may now be `0/2`. [To verify exact spell/effect and resource cost]
