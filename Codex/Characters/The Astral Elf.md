...
![The Astral Elf portrait](./Astral_Elf_portrait.png)

## One-Line Summary
An unnamed Astral Elf party member whose boldness, owl, and questionable ballista judgment have earned Dain's increased respect.
...
## What Dain Knows
- [Character-only] The Astral Elf is audacious enough to try launching Yuckie from a ballista.
- [Character-only] Dain respects this more than he probably should.
- [Character-only] Dain has promised to help the elf make the mountain ascent safely.

## What The Party Knows
- [Party] The Astral Elf's owl warned the party about the approaching ogres at the creek-fork camp.
- [Party] The Astral Elf killed Dain's suggested enemy before the party could exploit the enchantment further after the harpy fight.

## What Is Uncertain
- [To verify] Whether the Astral Elf understood Dain's plan for the suggested enemy.
