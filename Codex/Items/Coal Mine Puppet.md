...
![Coal Mine Puppet reference](./Coal_Mine_Puppet_ref.png)

## One-Line Summary
A strange cobalt puppet carried by one of the [Southern Human Traders](../Factions/Southern%20Human%20Traders.md), apparently able to interfere with [Dain Truthammer](../Characters/Dain%20Truthammer.md)'s attempt to cast `Identify`.

## Status
- [Party] [Confirmed] First appears on 2026-05-03 when a human trader sighs and pulls it out after [Kagrenac](../Characters/The%20Astral%20Elf.md) warns Dain in Draconic that the newcomers are glowing with magic.
- [Party] [Confirmed] Dain holds out his hand, shakes the puppet's hand, and attempts to cast `Identify`.
- [Character-only] [Inferred] The puppet seems to prevent Dain from casting or completing `Identify`.
- [Party] [Confirmed] The puppet speaks in a high voice and says, "unless you can take me back to the coal mines."
...
- [Party] A human trader sighs and produces the puppet.
- [Character-only] Dain tries a polite magical approach by shaking the puppet's hand while attempting `Identify`.
- [Character-only] The attempt fails, and the puppet appears to resist or prevent the spell. [Inferred]
- [Party] The puppet asks or demands to be taken back to the coal mines.
- [Character-only] Dain begins praying to [Garl Glittergold](../Lore/Garl%20Glittergold.md), and the puppet bites him.
...
- [Party] The puppet is connected in some way to the phrase "the coal mines."
...
- [To verify] Why the puppet wants to return there.
- [To verify] Why the southern traders are carrying it.
- [To verify] Whether the traders' magical glow comes from the puppet, carried goods, active spells, curses, disguises, or something else.
- [To verify] Whether the puppet is hostile, trapped, bound, bargaining, or simply annoying.
