...
![Goblin Camp Chest reference](./Goblin_Camp_Chest_ref.png)
...
- [To verify] Contents, lock/trap status, ownership markings, magical aura, weight, carrier, and whether the hobgoblin leader notices.
...
- [Party] The chest's contents are not yet recorded.
