...
## One-Line Summary
A dangerous in-progress pelt for Brother Taleesh that tries to solve "always-warm leather" through Dain's wet-heat, steam, and bad-idea genius.
...
- [Character-only] The pelt begins wet or damp, converts moisture into warmth, and can escalate into steam.
- [Character-only] If uncontrolled, the steam can become dangerous or lethal to the wearer.
...
## What Is Uncertain
- [To verify] Final safety mechanism: vents, limits, release flap, command word, temperature ceiling, or another constraint.
- [To verify] Whether it protects against cold, creates steam, inflicts heat/scalding, causes Wet, resists fire, or interacts with cold/fire/lightning damage.
...
- Design direction: damp hide, sealed warmth cycle, steam buildup, dangerous over-warmth.
