...
![Cobalt puppet invoking Kurtlemack](../../Adventures/2026-05-03/2026-05-03_cobalt-puppet-kurtlemack-reveal.png)

## One-Line Summary
A hostile name invoked by the [Cobalt / Coal Mine Puppet](../Items/Coal%20Mine%20Puppet.md) when Dain realizes what the puppet is.
...
## What Dain Knows
- [Character-only] The statement follows immediately after Dain begins praying to [Garl Glittergold](./Garl%20Glittergold.md) and the puppet bites him.
- [Character-only] The puppet's hostility appears connected to Dain's realization that it is a cobalt puppet, but the exact cause is [To verify].

## What The Party Knows
- [Party] The puppet says, "Kurtlemack hates you."
- [Party] The puppet is now recognized by Dain as a cobalt puppet. [To verify whether everyone else understands the significance]
