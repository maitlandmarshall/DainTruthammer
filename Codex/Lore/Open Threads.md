...
- Latest development: On 2026-06-20, after giving his last `5 gp` to the human/townsperson, Dain spends the next morning praying to [Garl Glittergold](./Garl%20Glittergold.md) about failing the pub moral lesson. A rat falls from the ceiling, and Dain begins writing a new spell in his wizard book / spellbook. The brainstorm shelf currently holds candidate names and mechanics; none are approved canon.
- Next possible actions: Choose the spell name, level, school, components, and target use case; decide whether the rat is real, illusory, fey, celestial, ordinary, or ambiguous; define what counts as a failed moral lesson; decide whether Dain must confess his own failure first; and ask Tom whether the spell can be researched or learned.
