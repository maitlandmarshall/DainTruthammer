...
- Latest development: On 2026-05-03, about 30 minutes after leaving the goblin camp and roughly at midday, [Kagrenac](../Characters/The%20Astral%20Elf.md)'s owl spots the [Smoky Scratch-Marked Cave](../Places/Smoky%20Scratch-Marked%20Cave.md): scratch marks on trees, fur on rocks, four very large claw marks, and smoke coming from the cave. As the party approaches, they hear grunting and growling; a voice yells, "you should leave." Dain yells back, "we're coming," and a [Werebear at Smoky Cave](../Characters/Werebear%20at%20Smoky%20Cave.md) reveals itself. Combat begins or escalates when [Brother Taleesh](../Characters/Brother%20Taleesh.md) bites and strikes the werebear, saying "ouch," while [Hammerton Harry Drizddon](../Characters/Hammerton%20Harry%20Drizddon.md) attacks with a hammer, missing once and hitting once. Dain then attempts to blind the werebear, but it succeeds on its Constitution save and is not blinded. The moon elf summons a weasel from a [Bag of Tricks](../Items/Bag%20of%20Tricks.md), and the werebear tries to hit and swing at it but completely misses. Dain then casts `Chromatic Orb` at the werebear and deals `11` acid damage. The werebear rolls a natural `1` swinging its greataxe at Taleesh / Jackson, loses the weapon, and sends it flying onto the cave roof out of reach.
- Next possible actions: Confirm initiative, total damage, the werebear's reaction, whether Taleesh's bite has any special mechanical consequence, whether parley is still possible, Dain's exact blinding spell/effect and resource cost, the Chromatic Orb resource source, Bag of Tricks owner/type, summoned weasel duration/stats, whether the greataxe can be retrieved, whether the goblin-pus smell matters, what is making the smoke, why the werebear warned the party away, and whether something worse is inside the cave.
