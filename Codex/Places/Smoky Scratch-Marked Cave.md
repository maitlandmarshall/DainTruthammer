# Smoky Scratch-Marked Cave

![Smoky Scratch-Marked Cave establishing image](./Smoky_Scratch_Marked_Cave_establishing.png)

## One-line summary
A smoky cave or nest in the forest, marked by huge four-claw scratches, fur on rocks, and signs of something large within.

## Status
- [Party] [Confirmed] Discovered on 2026-05-03 after the party leaves the goblin camp and travels about 30 minutes into the forest.
- [Party] [Confirmed] It is roughly midday when the cave/nest is spotted.
...
- [To verify] Whether the four scratch marks indicate claws, a symbol, a count, or territorial marking.
- [To verify] Whether the smell of goblin pus attracts, repels, disguises, or endangers the party.
