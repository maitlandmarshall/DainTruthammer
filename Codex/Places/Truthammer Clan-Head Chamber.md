# Truthammer Clan-Head Chamber

![Dain approaches the clan-head chamber](../../Adventures/2026-07-11/2026-07-11_dain-heads-to-meet-his-father.png)

## One-Line Summary
The formal, non-royal chamber where Dain's father conducts his role as head of the Truthammer clan.
...
## What Is Uncertain
- [To verify] Official name, architectural details, seating, guards, attendants, advisers, legal or political function, access rules, and whether the rest of the party enters.
- [To verify] Dain's father's formal title. `Magistrate` is rejected in the live description; `vizier` is mentioned but not completed or confirmed.
- [To verify] Whether this is an audience hall, council chamber, administrative court, clan hall, residence, or combination.
