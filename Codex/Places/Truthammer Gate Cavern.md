# Truthammer Gate Cavern

![Truthammer Gate Cavern](../../Adventures/2026-07-11/2026-07-11_truthammer-gate-cavern.png)

## One-Line Summary
A vast, naturally lit and heavily inhabited dwarven cavern immediately beyond the monumental gates of the Truthammer mountain stronghold.

## Status
- [Party] [Confirmed on 2026-07-11] The party enters after passing through the Truthammer gates between two monumental statues of dwarves holding axes.
- [Party] Natural light enters the cavern from openings high above.
...
## What Is Uncertain
- [To verify] Formal name, civic function, scale, population, leadership, guards, districts, businesses, defenses, connection to the airships, and relationship to Dain's father.
- [To verify] Whether the earlier comparable tower is the [Iron Shore Watchtower](./Iron%20Shore%20Watchtower.md), a structure in [Lerdar](./Lerdar.md), or another location.
- [To verify] Whether the architectural resemblance indicates common builders, clan influence, historical ties, a shared dwarven tradition, or only superficial similarity.
- [To verify] What the axe-bearing statues depict, whom they honor, and whether they have a defensive or magical function.
