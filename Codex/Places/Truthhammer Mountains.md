...
- [Character-only] [To verify] Dain knows or believes that local tunnels near the Truthhammer route may save travel time compared with a mountain detour.
...
- On 2026-06-20, the travel route brings the party close enough to Truthhammer Mountain / the Truthhammer route for Dain to weigh a mountain detour against local tunnels. The first explored tunnel is not safe: it leads through a grand door, hearth, hidden passage, and descending stair before the floor collapses over the Underdark.
...
- [Hidden Tunnel Near Truthammer Mountain](./Hidden%20Tunnel%20Near%20Truthammer%20Mountain.md)
